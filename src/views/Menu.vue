<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name=" 'headerBg' " row-key="id" default-expand-all @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" width="280" align="center">
        <template slot-scope="scope">
          ...
          <el-button type="primary" @click="handleAddd(scope.row.id)" v-if="!scope.row.pid && !scope.row.path">新增子菜单<i class="el-icon-edit"></i></el-button>
    ...
    <el-dialog title="菜单信息" :visible.sync="dialogFormVisible" width="30%" size="small">
